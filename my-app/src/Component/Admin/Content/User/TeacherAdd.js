...
const TeacherAdd = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if (isValid) {
            ...
            axiosClient.post(`Users/register-teacher?password=${password}`, teacher)
                .then((res) => {
                    if (file) {
                        const formData = new FormData();
                        formData.append("file", file);
                        axios.post(`https://localhost:7164/api/Users/upload/${teacher.userName}`, formData, {
                            headers: {
                        ...
                        <Row className="mb-3">
                            ...
                            <Form.Group as={Col} >
                                ...
                                <Form.Check
                                    ...
                                    name="gender"
                                    value={true}
                                    checked={teacher.gender === 'Nam'} // Sửa ở đây
                                    onChange={handleInput}
                                />
                                <Form.Check
                                    type="radio"
                                    ...
                                    name="gender"
                                    value={false}
                                    checked={teacher.gender === 'Nữ'} // Sửa ở đây
                                    onChange={handleInput}
                                />
